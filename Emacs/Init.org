...
- [[#keyboard-bindings][Keyboard Bindings]]
  ...
  - [[#modal-editing-with-my-own-package][Modal editing with my own package]]
  - [[#set-custom-keybinding][Set custom keybinding]]
    - [[#global-map-editing-map-on-future][Global map (Editing map on future)]]
...
(use-package general
  ...
  (general-create-definer my/editing-mode)

  (general-create-definer my/command-mode
    :keymaps 'custom-modal-mode-map)
...
#+end_src
** Modal editing with my own package
Defined on 'elisp/Custom-Modal.org'
#+begin_src emacs-lisp

(use-package in-custom-modal
  :ensure nil
  :hook (after-init . cm-mode))
;; (require 'in-custom-modal)
...
*** Global map (Editing map on future)
...
;; (my/command-mode
;;  "2" (λ (split-window-vertically) (other-window 1))
;;  "3" (λ (split-window-horizontally) (other-window 1))
;;  "C-x C-c" 'save-buffers-kill-terminal
;;  "C-g" 'keyboard-quit
;;  "C-G" 'keyboard-escape-quit
;;  "M-x" (λ (custom-modal-run-with-global-map 'counsel-M-x))
;;  )
...
(set-default 'cursor-type 'bar) ; bar is more intuitive
